...
INSERT INTO MVC_BOARD (bID, bNAME, bTITLE, bCONTENT, bGROUP, bSTEP, bINDENT, bIP)
    VALUES (MVC_BOARD_SEQ.NEXTVAL, '홍길동','제목','본문',
            MVC_BOARD_SEQ.CURRVAL, 0,0,'127.0.0.1');
...
INSERT INTO MVC_BOARD (bID, bNAME, bTITLE, bCONTENT, bGROUP, bSTEP, bINDENT, bIP)
    VALUES (MVC_BOARD_SEQ.NEXTVAL, '홍길동','제목2','본문2',
            MVC_BOARD_SEQ.CURRVAL, 0,0,'127.0.0.1');
-- bId글 조회수 1회 올리기
...
DELETE FROM MVC_BOARD WHERE Bip='127.0.0.1';