...
<body>
	...
	<%suParam = request.getParameter("su");
		if(suParam!=null){
			...
			if(su!=computerSu){
				String msg = "<h2>Wron! Try Again!</h2>"+
										"<h2>("+su+"은(는) 아니고 정답은 "+computerSu+")</h2>";
				msg = URLEncoder.encode(msg,"utf-8");
				response.sendRedirect("ex08_yaba.jsp?msg="+msg);
			}	
		}else{
			response.sendRedirect("ex08_yaba.jsp");
		}
	%>
		<h2>정답입니다</h2>
		<h2>동전이 있던 곳은 <%=su %></h2>
		<button onclick="location.href='ex08_yaba.jsp'">다시 도전</button>
	</div>
</body>
</html>